...
func NewPortainerClient(serverAddress, edgeID string, getEndpointIDFn func() string, agentPlatform agent.ContainerPlatform, httpClient *http.Client) PortainerClient {
	return NewPortainerEdgeClient(serverAddress, edgeID, getEndpointIDFn, agentPlatform, httpClient)
}
