...
func (manager *StackManager) deployStack(ctx context.Context, stack *edgeStack, stackName, stackFileLocation string) {
	...
	if err != nil {
		log.Error().Stack().Err(err).Msg("stack deployment failed")
	...
	if err != nil {
		log.Error().Stack().Err(err).Msg("unable to update Edge stack status")
	}
}
...
func (manager *StackManager) deleteStack(ctx context.Context, stack *edgeStack, stackName, stackFileLocation string) {
	...
	if err != nil {
		log.Error().Stack().Err(err).Msg("unable to remove stack")
	...
	if err != nil {
		log.Error().Stack().Err(err).Msg("unable to delete Edge stack file")
	...
	if err != nil {
		log.Error().Stack().Err(err).Msg("unable to delete Edge stack status")
